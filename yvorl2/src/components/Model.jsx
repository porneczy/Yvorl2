    ...
    return (
        <group ref={group} {...props} dispose={null}>
            <group name="Scene">
                ...
                <PerspectiveCamera name="Camera001" makeDefault={true} far={1000} near={0.01} fov={57.3} position={[-1.05, 2.22, 6.43]} rotation={[-0.03, 0.08, 0]} />
                {/* <pointLight name="Light" intensity={1000} decay={2} position={[4.08, 5.9, -1.01]} rotation={[-1.84, 0.6, 1.93]} />
                  <PerspectiveCamera name="Camera001" makeDefault={false} far={1000} near={0.01} fov={37.3} position={[-1.05, 2.22, 6.43]} rotation={[-0.03, 0.08, 0]} /> */}
